...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-05-2024 a las 18:52:46
...
CREATE TABLE `cotizaciones` (
  ...
  `descuento` varchar(3) NOT NULL DEFAULT '0',
  `impuesto` varchar(3) NOT NULL DEFAULT '19%',
...
INSERT INTO `cotizaciones` (`id`, `material`, `descripcion`, `unidad`, `precio`, `descuento`, `impuesto`, `proveedor`) VALUES
...
(9, 'arena', 'fuerte', 'litro', 50, '', '', 'Amarilo');
...
INSERT INTO `pedidos` (`id`, `obra_id`, `usuario`, `producto`, `precio`, `cantidad`, `unidad`, `fecha_pedido`, `estado`, `historial`, `descuento`, `impuesto`) VALUES
(1, 1, 'taylor', 'Cemento', 0, 5, 'litro', '2024-04-07 21:37:33', 0, 0, 0, 0),
(2, 1, 'taylor', 'pintura', 0, 457, 'galon', '2024-04-07 21:37:33', 0, 0, 0, 0),
(3, 1, 'taylor', 'Tornillos', 540, 567, 'tr', '2024-04-07 21:37:33', 0, 0, 0, 0),
(4, 1, 'taylor', 'arena', 0, 7, 'bultos', '2024-04-16 18:13:30', 1, 0, 0, 0),
(5, 1, 'taylor', 'Cemento', 850, 8, 'bultos', '2024-04-16 18:13:30', 1, 0, 0, 0),
